...
Route::middleware(['auth', 'user.status'])->group(function () {
    ...
    // Berita Management Routes - FIXED
    Route::prefix('berita')->name('berita.')->group(function () {
        Route::get('/', [BeritaController::class, 'index'])->name('index');
        Route::get('/create', [BeritaController::class, 'create'])->name('create')->middleware('role:admin,kades,rw,rt');
        Route::post('/', [BeritaController::class, 'store'])->name('store')->middleware('role:admin,kades,rw,rt');
        Route::get('/{berita}', [BeritaController::class, 'show'])->name('show');
        Route::get('/{berita}/edit', [BeritaController::class, 'edit'])->name('edit')->middleware('role:admin,kades,rw,rt');
        Route::put('/{berita}', [BeritaController::class, 'update'])->name('update')->middleware('role:admin,kades,rw,rt');
        Route::delete('/{berita}', [BeritaController::class, 'destroy'])->name('destroy')->middleware('role:admin,kades,rw,rt');
        Route::post('/{berita}/toggle-pin', [BeritaController::class, 'togglePin'])->name('togglePin')->middleware('role:admin,kades,rw,rt');
    });
