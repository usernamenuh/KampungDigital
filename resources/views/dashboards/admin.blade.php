...
return {
    ...
    async loadMonthlyKasData() {
        try {
            ...
            const response = await fetch('/api/dashboard/monthly-kas', { // Corrected API route
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    async loadActivities() {
        try {
            const response = await fetch('/api/dashboard/activities?limit=20', { // Corrected API route
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    async loadSystemMonitoring() {
        try {
            const response = await fetch('/api/dashboard/system-monitoring', { // Corrected API route
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    async clearCache() {
        try {
            const response = await fetch('/api/dashboard/clear-cache', { // Corrected API route
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    async checkSystemHealth() {
        try {
            const response = await fetch('/api/dashboard/system-health', { // Corrected API route
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
