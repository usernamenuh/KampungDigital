...
<div x-data="rwDashboardData()" x-init="initDashboard()" class="p-6 space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="flex items-center mt-2">
                        <span class="text-sm text-blue-600 font-medium">Di bawah RW Anda</span>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-all hover:shadow-md">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="flex items-center mt-2">
                        <span class="text-sm text-green-600 font-medium">Di wilayah RW Anda</span>
                    </div>
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('rt.index') }}" class="flex flex-col items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
