              ...
              @if($kas->bukti_bayar_file)
                  <div class="mb-4 border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
                      ...
                      @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif']))
                          <img src="{{ Storage::url($kas->bukti_bayar_file) }}" alt="Bukti Pembayaran" class="w-full h-auto object-cover max-h-96">
                  ...
                  <div class="flex items-center space-x-2">
                      ...
                      @if(in_array($fileExtension, ['pdf']))
                          <a href="{{ Storage::url($kas->bukti_bayar_file) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
