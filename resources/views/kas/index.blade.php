    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">Kelola data kas warga RT</p>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Total Kas</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($stats['total']) }}</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Total keseluruhan</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 dark:text-green-400">{{ number_format($stats['lunas']) }}</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Sudah dibayar</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-600 dark:text-yellow-400">{{ number_format($stats['belum_bayar']) }}</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Menunggu pembayaran</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-red-600 dark:text-red-400">{{ number_format($stats['terlambat']) }}</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Melewati jatuh tempo</p>
                </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300">
                        {{ $stats['belum_bayar'] + $stats['terlambat'] }} kas belum bayar
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mt-2 px-7 py-3">
                ...
                <div class="mt-4 bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            <span class="font-medium text-gray-700 dark:text-gray-300">Notifikasi:</span>
                            <span class="text-gray-900 dark:text-white">{{ session('notifications_sent') }}</span>
                        </div>
