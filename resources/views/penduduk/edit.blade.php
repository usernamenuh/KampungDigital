    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Data Penduduk</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $penduduk->nama_lengkap }} - {{ $penduduk->nik }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
            <form action="{{ route('penduduk.update', $penduduk) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Foto Saat Ini</h3>
                    <div class="flex items-center space-x-4">
                        <img src="{{ asset('storage/' . $penduduk->foto) }}" alt="Foto {{ $penduduk->nama_lengkap }}" class="w-24 h-24 rounded-full object-cover border-4 border-gray-200 dark:border-gray-600">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Foto yang sedang digunakan</p>
                ...
                <!-- Data Pribadi -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Data Pribadi</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="nik" name="nik" maxlength="16" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('nik') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" value="{{ old('nik', $penduduk->nik) }}" required>
                            @error('nik')
                        ...
                        <div>
                            ...
                            <input type="text" id="tempat_lahir" name="tempat_lahir" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('tempat_lahir') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" value="{{ old('tempat_lahir', $penduduk->tempat_lahir) }}" required>
                            @error('tempat_lahir')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('tanggal_lahir') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" value="{{ old('tanggal_lahir', $penduduk->tanggal_lahir->format('Y-m-d')) }}" required>
                            @error('tanggal_lahir')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <!-- Data Keluarga -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Data Keluarga</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_ibu" name="nama_ibu" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('nama_ibu') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" value="{{ old('nama_ibu', $penduduk->nama_ibu) }}">
                            @error('nama_ibu')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <!-- Data Tambahan -->
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Data Tambahan</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="pekerjaan" name="pekerjaan" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('pekerjaan') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" value="{{ old('pekerjaan', $penduduk->pekerjaan) }}">
                            @error('pekerjaan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="kewarganegaraan" name="kewarganegaraan" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('kewarganegaraan') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" value="{{ old('kewarganegaraan', $penduduk->kewarganegaraan) }}">
                        ...
                        <div>
                            <label for="status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Status Penduduk <span class="text-red-500">*</span></label>
                            <select id="status" name="status" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('status') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white" required>
                                <option value="">Pilih Status</option>
                        ...
                        @if($jabatan)
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Jabatan Saat Ini</label>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('keterangan') border-red-500 @enderror bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('keterangan', $penduduk->keterangan) }}</textarea>
                            @error('keterangan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
