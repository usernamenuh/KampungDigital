    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
        <form method="GET" class="flex flex-wrap items-end gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('payments.list') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 transition-colors">
                    Reset
                </a>
            </div>
        </form>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                            ...
                            @elseif($payment->metode_bayar === 'tunai')
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('payments.proof', $payment->id) }}" 
...
function processConfirmation() {
    ...
    fetch(`/api/payment/${currentKasId}/confirm`, { // Corrected API route
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
            ...
            catatan_konfirmasi: notes // Changed to catatan_konfirmasi
        })
    })
