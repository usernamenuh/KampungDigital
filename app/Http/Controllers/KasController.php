...
class KasController extends Controller
{
    ...
    public function bayar(Request $request, Kas $kas)
    {
        ...
        if ($kas->status === 'lunas') {
            return response()->json(['success' => false, 'message' => 'Kas ini sudah lunas'], 400);
        }
        ...
        try {
            ...
            return response()->json(['success' => false, 'message' => 'Gagal menandai kas lunas: ' . $e->getMessage()], 500);
        }
    }
